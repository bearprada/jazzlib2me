...
//  	  System.err.print("writeSymbol("+freqs.length+","+code+"): ");
    ...
    final void checkEmpty() throws InternalError
    {
      boolean empty = true;
      for (int i = 0; i < freqs.length; i++)
	if (freqs[i] != 0)
  ...
  public void sendAllTrees(int blTreeCodes) throws InternalError {
    blTree.buildCodes();
  ...
  public void compressBlock() throws InternalError {
  ...
  public void flushBlock(byte[] stored, int stored_offset, int stored_len,
			 boolean lastBlock) throws InternalError {
