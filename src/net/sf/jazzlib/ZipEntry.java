...
import lab.prada.j2me.zip.CloneNotSupportedException;
import lab.prada.j2me.zip.Cloneable;
...
//	ZipEntry clone = (ZipEntry) this.clone();
//	if (extra != null)
...
//      }
  ...
  private ZipEntry _clone(){
	  ZipEntry z = new ZipEntry(this.name);
	  z.size = this.size;
	  z.compressedSize = this.compressedSize;
	  z.crc = this.crc;
	  z.dostime = this.dostime;
	  z.known = this.known;
	  z.method = this.method;
	  z.comment = this.comment;
	  if(extra!=null){
		  z.extra = new byte[this.extra.length];
		  System.arraycopy(this.extra, 0, z.extra, 0 , this.extra.length);
	  }
	  z.flags = this.flags;
	  z.offset = this.offset;
//	  int flags;              /* used by ZipOutputStream */
//	  int offset;             /* used by ZipFile and ZipOutputStream */
