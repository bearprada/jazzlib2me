...
class DeflaterEngine implements DeflaterConstants {
  ...
  public void setLevel(int lvl) throws InternalError
  {
 ...
 * @throws InternalError 
   */
  private boolean findLongestMatch(int curMatch) throws InternalError {
...
//  	  System.err.println("Found match: "+curMatch+"-"+(scan-strstart));
  ...
  void setDictionary(byte[] buffer, int offset, int length) throws InternalError {
  ...
  private boolean deflateFast(boolean flush, boolean finish) throws InternalError
  {
  ...
  private boolean deflateSlow(boolean flush, boolean finish) throws InternalError
  {
    if (lookahead < MIN_LOOKAHEAD && !flush)
      return false;
  ...
  public boolean deflate(boolean flush, boolean finish) throws InternalError 
  {
    boolean progress;
    do
      {
