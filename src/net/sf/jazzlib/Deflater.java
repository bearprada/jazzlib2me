 ...
 * @throws InternalError 
   */
  public int deflate(byte[] output) throws InternalError
  {
 ...
 * @throws InternalError 
   ...
   */
  public int deflate(byte[] output, int offset, int length) throws InternalError
  {
 ...
 * @throws InternalError 
   ...
   */
  public void setDictionary(byte[] dict) throws InternalError
  {
 ...
 * @throws InternalError 
   ...
   */
  public void setDictionary(byte[] dict, int offset, int length) throws InternalError
  {
    if (state != INIT_STATE)
